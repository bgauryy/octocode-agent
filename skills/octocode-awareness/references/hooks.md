...
Choose one surface. With Claude frontmatter, preview/remove legacy project or global Awareness hooks; do not also install them. Preview, install after approval, then check:
