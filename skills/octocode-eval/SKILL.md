---
name: octocode-eval
description: "Use when quality or improvement benefits from measurement: analyze failures, define goal-to-KPI contracts, build or audit eval suites, benchmark systems, run keep/discard experiments, protect held-out checks, or decide whether a change genuinely helped."
---
# Octocode Eval
...
- When changing this skill, run `scripts/eval-eval.mjs` against `evals/cases.json` — catch self-routing regressions.
