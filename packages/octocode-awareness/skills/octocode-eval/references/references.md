...
| File | Path | Notes |
|------|------|-------|
| Thesis | packages/octocode-awareness/docs/THESIS.md | harness sensors |
| Improve loop | skills/*/references/improve-loop.md | goal→KPI→remeasure |
| Eval harnesses | skills/octocode-research|brainstorming|rfc-generator | cases + binaryQuestions |
