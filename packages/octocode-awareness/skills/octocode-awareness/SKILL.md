...
- **Skill evolution:** when shipping a skill change, load `references/skill-evolution.md`; define the goal/KPI, gather evidence with available Octocode tools, and review with focused checks.
