...
const commandIndex = [
  ...
  { command: "refinement list", schema: "refine_query", use: "Alias of refinement get; matches the routing table and CLI help.", example: 'octocode-awareness refinement list --workspace "$PWD" --compact' },
