...
export function renderDeveloperReviewDoc(rows: AwarenessQueryRow[], maxLines: number): string {
  ...
  const lines = [
    '# Developer Review',
    '',
    '<!-- Generated by `npx @octocodeai/octocode-awareness reflect developer-review --format markdown`. -->',
    '',
  ...
  if (rows.length === 0) {
    lines.push(
      ...
      '`npx @octocodeai/octocode-awareness reflect record --outcome partial --task "<what you did>" \\',
