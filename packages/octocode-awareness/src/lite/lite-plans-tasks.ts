...
import { LiteBase } from './lite-core.js';
import { DEFAULT_AGENT_PRESENCE_MS,id,normalizeLeaseSeconds,now,planFromRow,PlanRow,required,splitFiles,taskFromRow,TaskRow } from './lite-shared.js';

export abstract class LitePlansTasks extends LiteBase {
