...
import { LiteMemoryAgents } from './lite-memory-agents.js';
import { agentFromRow,AgentRow,cutoffIso,handoffFromRow,HandoffRow,LiteSchema,lockFromRow,LockRow,memoryFromRow,MemoryRow,messageFromRow,MessageRow,now,taskFromRow,TaskRow,workPresenceFromRow,WorkPresenceRow } from './lite-shared.js';

export abstract class LiteSchemaHelpers extends LiteMemoryAgents {
  schema(): LiteSchema {
    return {
      entities: {
