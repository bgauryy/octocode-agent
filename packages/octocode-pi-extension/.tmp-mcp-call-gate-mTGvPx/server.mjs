    ...
    server.setRequestHandler('tools/call', async (request) => {
      fs.appendFileSync("/Users/bgaryy/code/octocode-agent/packages/octocode-pi-extension/.tmp-mcp-call-gate-mTGvPx/called.ndjson", JSON.stringify(request.params) + '\n');
