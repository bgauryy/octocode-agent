    ...
    server.setRequestHandler('tools/call', async (request) => {
      fs.appendFileSync("/Users/bgaryy/code/octocode-agent/packages/octocode-pi-extension/.tmp-mcp-call-gate-iIVqpp/called.ndjson", JSON.stringify(request.params) + '\n');
