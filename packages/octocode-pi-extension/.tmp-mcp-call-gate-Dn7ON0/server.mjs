    ...
    server.setRequestHandler('tools/call', async (request) => {
      fs.appendFileSync("/Users/bgaryy/code/octocode-agent/packages/octocode-pi-extension/.tmp-mcp-call-gate-Dn7ON0/called.ndjson", JSON.stringify(request.params) + '\n');
