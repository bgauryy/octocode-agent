 ...
 */
export function getCLIPath(baseDir = extensionDir) {
    ...
    console.warn(`[octocode-pi-extension] Warning: CLI not found at ${bundled} or in node_modules. ` +
 ...
 */
const _awarenessCliPathCache = new Map();
export function getAwarenessCLIPath(baseDir = extensionDir) {
    ...
    if (fs.existsSync(sourceMode)) {
        _awarenessCliPathCache.set(baseDir, sourceMode);
        return sourceMode;
    }
    ...
    console.warn(`[octocode-pi-extension] Warning: awareness CLI not found at ${bundled} or ${sourceMode}. ` +
