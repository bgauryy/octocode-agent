/**
 * Optional semantic-memory embeddings for Awareness Lite — zero runtime deps.
 *
 ...
 *
 * When OCTOCODE_EMBED_CMD is unset, embeddings are simply skipped and memory
 * recall stays lexical (LIKE) — Lite keeps working with no configuration.
 */
